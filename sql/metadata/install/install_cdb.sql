...
PROMPT INFO: Creating Live SQL METADATA PDB...
...
GRANT CREATE MATERIALIZED VIEW TO "^PDB_ADMIN_USERNAME" WITH ADMIN OPTION;
GRANT CREATE VIEW TO "^PDB_ADMIN_USERNAME" WITH ADMIN OPTION;
GRANT CREATE TABLE TO "^PDB_ADMIN_USERNAME" WITH ADMIN OPTION;
...
GRANT CTXAPP TO "^PDB_ADMIN_USERNAME" WITH ADMIN OPTION;
GRANT READ, WRITE ON DIRECTORY DATA_PUMP_DIR TO "^PDB_ADMIN_USERNAME";

-- NOTE: Not doing ORDS operations here because it may not be installed in the PDB at this point

PROMPT INFO: Live SQL METADATA PDB created
