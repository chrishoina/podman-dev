...
BEGIN
    ...
    EXECUTE IMMEDIATE 'DROP ROLE LIVE_SQL_READ_ONLY_USER';
    EXECUTE IMMEDIATE 'DROP ROLE LIVE_SQL_READ_WRITE_USER';
EXCEPTION
    WHEN OTHERS THEN
        NULL;
END;
...
@@../sample_schemas/customer_orders/co_uninstall.sql
@@../sample_schemas/human_resources/hr_uninstall.sql
@@../sample_schemas/sales_history/sh_uninstall.sql
...
PROMPT INFO: Re-run uninstall.sql at the PDB using a non Live SQL user to drop the schemas or at the CDB level to drop the SCHEMAS PDB
